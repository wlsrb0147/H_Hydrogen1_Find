	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 triplanar70 = TriplanarSampling70( _MicroDetail, ase_worldPos, normalWS, 1.0, temp_cast_0, 1.0, 0 );
				float lerpResult74 = lerp( 1.0 , ( triplanar70.y + 0.5 ) , _MicroDetailIntensity);
				float2 uv_Diffuse = packedInput.ase_texcoord5.xy * _Diffuse_ST.xy + _Diffuse_ST.zw;
				...
				float2 texCoord49 = packedInput.ase_texcoord5.xy * temp_cast_1 + float2( 0,0 );
				...
				float2 texCoord50 = packedInput.ase_texcoord5.xy * temp_cast_3 + float2( 0,0 );
				...
				float2 texCoord55 = packedInput.ase_texcoord5.xy * temp_cast_4 + float2( 0,0 );
				float2 temp_cast_5 = (( _Sand_MASTER_UV_Scale * _SandNormalScale2 )).xx;
				float2 texCoord59 = packedInput.ase_texcoord5.xy * temp_cast_5 + float2( 0,0 );
				...
				surfaceDescription.BaseColor = lerpResult36.rgb;
				surfaceDescription.Normal = lerpResult6;
				...
				surfaceDescription.Smoothness = ( lerpResult78 * lerpResult87 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 triplanar70 = TriplanarSampling70( _MicroDetail, ase_worldPos, ase_worldNormal, 1.0, temp_cast_0, 1.0, 0 );
				float lerpResult74 = lerp( 1.0 , ( triplanar70.y + 0.5 ) , _MicroDetailIntensity);
				float2 uv_Diffuse = packedInput.ase_texcoord4.xy * _Diffuse_ST.xy + _Diffuse_ST.zw;
				float4 tex2DNode2 = tex2D( _Diffuse, uv_Diffuse );
				float4 temp_output_250_0 = ( _SandColorOverrideColor * _SandBrightness );
				float3 normalizedWorldNormal = normalize( ase_worldNormal );
				float dotResult247 = dot( normalizedWorldNormal , float3( 0,1,0 ) );
				float clampResult248 = clamp( dotResult247 , 0.0 , 1.0 );
				float2 uv_Normal = packedInput.ase_texcoord4.xy * _Normal_ST.xy + _Normal_ST.zw;
				float3 tex2DNode98 = UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0f );
				float clampResult43 = clamp( ( ( ( clampResult248 * tex2DNode98.b ) * 2.0 ) * _SandAmount ) , 0.0 , 1.0 );
				float2 temp_cast_1 = (_SandMaskScale).xx;
				float2 texCoord49 = packedInput.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float lerpResult51 = lerp( 1.0 , tex2D( _SandMask, texCoord49 ).g , _SandMaskAmount);
				float temp_output_44_0 = ( clampResult43 * lerpResult51 );
				float4 lerpResult36 = lerp( ( lerpResult74 * ( tex2DNode2 * _DiffuseMultiply * _DiffuseBrightness ) ) , temp_output_250_0 , temp_output_44_0);
				
				float2 temp_cast_3 = (_NormalDetailScale).xx;
				float2 texCoord50 = packedInput.ase_texcoord4.xy * temp_cast_3 + float2( 0,0 );
				float3 unpack99 = UnpackNormalScale( tex2D( _NormalDetail, texCoord50 ), _NormalDetailIntensity );
				unpack99.z = lerp( 1, unpack99.z, saturate(_NormalDetailIntensity) );
				float2 temp_cast_4 = (( _Sand_MASTER_UV_Scale * _SandNormalScale1 )).xx;
				float2 texCoord55 = packedInput.ase_texcoord4.xy * temp_cast_4 + float2( 0,0 );
				float2 temp_cast_5 = (( _Sand_MASTER_UV_Scale * _SandNormalScale2 )).xx;
				float2 texCoord59 = packedInput.ase_texcoord4.xy * temp_cast_5 + float2( 0,0 );
				float3 lerpResult6 = lerp( BlendNormal( tex2DNode98 , unpack99 ) , BlendNormal( UnpackNormalScale( tex2D( _SandNormal, texCoord55 ), 1.0f ) , UnpackNormalScale( tex2D( _SandNormal, texCoord59 ), 1.0f ) ) , temp_output_44_0);
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord50 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float3 unpack99 = UnpackNormalScale( tex2D( _NormalDetail, texCoord50 ), _NormalDetailIntensity );
				unpack99.z = lerp( 1, unpack99.z, saturate(_NormalDetailIntensity) );
				float2 temp_cast_1 = (( _Sand_MASTER_UV_Scale * _SandNormalScale1 )).xx;
				float2 texCoord55 = packedInput.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float2 temp_cast_2 = (( _Sand_MASTER_UV_Scale * _SandNormalScale2 )).xx;
				float2 texCoord59 = packedInput.ase_texcoord3.xy * temp_cast_2 + float2( 0,0 );
				float3 normalizedWorldNormal = normalize( normalWS );
				float dotResult247 = dot( normalizedWorldNormal , float3( 0,1,0 ) );
				float clampResult248 = clamp( dotResult247 , 0.0 , 1.0 );
				float clampResult43 = clamp( ( ( ( clampResult248 * tex2DNode98.b ) * 2.0 ) * _SandAmount ) , 0.0 , 1.0 );
				float2 temp_cast_3 = (_SandMaskScale).xx;
				float2 texCoord49 = packedInput.ase_texcoord3.xy * temp_cast_3 + float2( 0,0 );
				float lerpResult51 = lerp( 1.0 , tex2D( _SandMask, texCoord49 ).g , _SandMaskAmount);
				float temp_output_44_0 = ( clampResult43 * lerpResult51 );
				float3 lerpResult6 = lerp( BlendNormal( tex2DNode98 , unpack99 ) , BlendNormal( UnpackNormalScale( tex2D( _SandNormal, texCoord55 ), 1.0f ) , UnpackNormalScale( tex2D( _SandNormal, texCoord59 ), 1.0f ) ) , temp_output_44_0);
				
				float2 uv_Diffuse = packedInput.ase_texcoord3.xy * _Diffuse_ST.xy + _Diffuse_ST.zw;
				float4 tex2DNode2 = tex2D( _Diffuse, uv_Diffuse );
				float lerpResult77 = lerp( _SpecularA , _SpecularB , tex2DNode2.a);
				float clampResult249 = clamp( lerpResult77 , 0.1 , 1.0 );
				float lerpResult78 = lerp( clampResult249 , _SpecularSand , temp_output_44_0);
		...
		Pass
		{
						...
						)
			{
				...
				float4 triplanar70 = TriplanarSampling70( _MicroDetail, ase_worldPos, normalWS, 1.0, temp_cast_0, 1.0, 0 );
				float lerpResult74 = lerp( 1.0 , ( triplanar70.y + 0.5 ) , _MicroDetailIntensity);
				float2 uv_Diffuse = packedInput.ase_texcoord7.xy * _Diffuse_ST.xy + _Diffuse_ST.zw;
				float4 tex2DNode2 = tex2D( _Diffuse, uv_Diffuse );
				float4 temp_output_250_0 = ( _SandColorOverrideColor * _SandBrightness );
				float3 normalizedWorldNormal = normalize( normalWS );
				float dotResult247 = dot( normalizedWorldNormal , float3( 0,1,0 ) );
				...
				float clampResult43 = clamp( ( ( ( clampResult248 * tex2DNode98.b ) * 2.0 ) * _SandAmount ) , 0.0 , 1.0 );
				float2 temp_cast_1 = (_SandMaskScale).xx;
				float2 texCoord49 = packedInput.ase_texcoord7.xy * temp_cast_1 + float2( 0,0 );
				float lerpResult51 = lerp( 1.0 , tex2D( _SandMask, texCoord49 ).g , _SandMaskAmount);
				float temp_output_44_0 = ( clampResult43 * lerpResult51 );
				float4 lerpResult36 = lerp( ( lerpResult74 * ( tex2DNode2 * _DiffuseMultiply * _DiffuseBrightness ) ) , temp_output_250_0 , temp_output_44_0);
				
				float2 temp_cast_3 = (_NormalDetailScale).xx;
				float2 texCoord50 = packedInput.ase_texcoord7.xy * temp_cast_3 + float2( 0,0 );
				float3 unpack99 = UnpackNormalScale( tex2D( _NormalDetail, texCoord50 ), _NormalDetailIntensity );
				unpack99.z = lerp( 1, unpack99.z, saturate(_NormalDetailIntensity) );
				float2 temp_cast_4 = (( _Sand_MASTER_UV_Scale * _SandNormalScale1 )).xx;
				float2 texCoord55 = packedInput.ase_texcoord7.xy * temp_cast_4 + float2( 0,0 );
				float2 temp_cast_5 = (( _Sand_MASTER_UV_Scale * _SandNormalScale2 )).xx;
				float2 texCoord59 = packedInput.ase_texcoord7.xy * temp_cast_5 + float2( 0,0 );
				float3 lerpResult6 = lerp( BlendNormal( tex2DNode98 , unpack99 ) , BlendNormal( UnpackNormalScale( tex2D( _SandNormal, texCoord55 ), 1.0f ) , UnpackNormalScale( tex2D( _SandNormal, texCoord59 ), 1.0f ) ) , temp_output_44_0);
...
WireConnection;252;0;36;0
WireConnection;252;1;6;0
WireConnection;252;7;263;0
WireConnection;263;0;78;0
WireConnection;263;1;87;0
ASEEND*/
//CHKSM=6CAC80C5415ED56E7993794D4E1EE1096FAD13A8