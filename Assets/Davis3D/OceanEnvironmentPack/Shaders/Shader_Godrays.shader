	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 hdEmission109 = ASEGetEmissionHDRColor(temp_cast_0,ConvertEvToLuminance(1.0),0.0,GetInverseCurrentExposureMultiplier());
				
				float4 screenPos = packedInput.ase_texcoord5;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth28 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				float2 texCoord78 = packedInput.ase_texcoord6.xy * temp_cast_1 + float2( 0,0 );
				float2 panner84 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord78);
				float2 temp_cast_2 = (_TilingB).xx;
				float2 texCoord86 = packedInput.ase_texcoord6.xy * temp_cast_2 + float2( 0,0 );
				float2 panner83 = ( 1.0 * _Time.y * float2( -0.2,0 ) + texCoord86);
				float fresnelNdotV20 = dot( normalWS, V );
				float fresnelNode20 = ( 0.0 + 3.0 * pow( max( 1.0 - fresnelNdotV20 , 0.0001 ), 1.5 ) );
				...
				float2 uv_T_Gradient_Vertical_2wayB = packedInput.ase_texcoord6.xy * _T_Gradient_Vertical_2wayB_ST.xy + _T_Gradient_Vertical_2wayB_ST.zw;
				...
				surfaceDescription.Emission = hdEmission109;
				surfaceDescription.Smoothness = 0.5;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = ( clampResult97 * ( ( _Glow * clampResult92 ) * tex2D( _T_Gradient_Vertical_2wayB, uv_T_Gradient_Vertical_2wayB ).g ) ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float clampResult97 = clamp( lerpResult95 , 0.0 , 1.0 );
				float2 temp_cast_1 = (_TilingA).xx;
				float2 texCoord78 = packedInput.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float2 panner84 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord78);
				float2 temp_cast_2 = (_TilingB).xx;
				float2 texCoord86 = packedInput.ase_texcoord3.xy * temp_cast_2 + float2( 0,0 );
				float2 panner83 = ( 1.0 * _Time.y * float2( -0.2,0 ) + texCoord86);
				...
				float4 lerpResult19 = lerp( ( tex2D( _BeamGradientA, panner84 ) * tex2D( _BeamGradientB, panner83 ) ) , float4( 0,0,0,0 ) , fresnelNode20);
				float4 clampResult92 = clamp( lerpResult19 , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float2 uv_T_Gradient_Vertical_2wayB = packedInput.ase_texcoord3.xy * _T_Gradient_Vertical_2wayB_ST.xy + _T_Gradient_Vertical_2wayB_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord78 = packedInput.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float2 panner84 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord78);
				float2 temp_cast_1 = (_TilingB).xx;
				float2 texCoord86 = packedInput.ase_texcoord2.xy * temp_cast_1 + float2( 0,0 );
				float2 panner83 = ( 1.0 * _Time.y * float2( -0.2,0 ) + texCoord86);
				float3 ase_worldNormal = packedInput.ase_texcoord3.xyz;
				float fresnelNdotV20 = dot( ase_worldNormal, V );
				float fresnelNode20 = ( 0.0 + 3.0 * pow( max( 1.0 - fresnelNdotV20 , 0.0001 ), 1.5 ) );
				float4 lerpResult19 = lerp( ( tex2D( _BeamGradientA, panner84 ) * tex2D( _BeamGradientB, panner83 ) ) , float4( 0,0,0,0 ) , fresnelNode20);
				float4 clampResult92 = clamp( lerpResult19 , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float2 uv_T_Gradient_Vertical_2wayB = packedInput.ase_texcoord2.xy * _T_Gradient_Vertical_2wayB_ST.xy + _T_Gradient_Vertical_2wayB_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float clampResult97 = clamp( lerpResult95 , 0.0 , 1.0 );
				float2 temp_cast_0 = (_TilingA).xx;
				float2 texCoord78 = packedInput.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float2 panner84 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord78);
				float2 temp_cast_1 = (_TilingB).xx;
				float2 texCoord86 = packedInput.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float2 panner83 = ( 1.0 * _Time.y * float2( -0.2,0 ) + texCoord86);
				float fresnelNdotV20 = dot( normalWS, V );
				float fresnelNode20 = ( 0.0 + 3.0 * pow( max( 1.0 - fresnelNdotV20 , 0.0001 ), 1.5 ) );
				float4 lerpResult19 = lerp( ( tex2D( _BeamGradientA, panner84 ) * tex2D( _BeamGradientB, panner83 ) ) , float4( 0,0,0,0 ) , fresnelNode20);
				float4 clampResult92 = clamp( lerpResult19 , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float2 uv_T_Gradient_Vertical_2wayB = packedInput.ase_texcoord4.xy * _T_Gradient_Vertical_2wayB_ST.xy + _T_Gradient_Vertical_2wayB_ST.zw;
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord8.xy = inputMesh.ase_texcoord.xy;
						...
						)
			{
				...
				float clampResult97 = clamp( lerpResult95 , 0.0 , 1.0 );
				float2 temp_cast_1 = (_TilingA).xx;
				float2 texCoord78 = packedInput.ase_texcoord8.xy * temp_cast_1 + float2( 0,0 );
				float2 panner84 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord78);
				float2 temp_cast_2 = (_TilingB).xx;
				float2 texCoord86 = packedInput.ase_texcoord8.xy * temp_cast_2 + float2( 0,0 );
				float2 panner83 = ( 1.0 * _Time.y * float2( -0.2,0 ) + texCoord86);
				float fresnelNdotV20 = dot( normalWS, V );
				float fresnelNode20 = ( 0.0 + 3.0 * pow( max( 1.0 - fresnelNdotV20 , 0.0001 ), 1.5 ) );
				float4 lerpResult19 = lerp( ( tex2D( _BeamGradientA, panner84 ) * tex2D( _BeamGradientB, panner83 ) ) , float4( 0,0,0,0 ) , fresnelNode20);
				float4 clampResult92 = clamp( lerpResult19 , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float2 uv_T_Gradient_Vertical_2wayB = packedInput.ase_texcoord8.xy * _T_Gradient_Vertical_2wayB_ST.xy + _T_Gradient_Vertical_2wayB_ST.zw;
		...
		Pass
        {
					...
					)
			{
				...
				float clampResult97 = clamp( lerpResult95 , 0.0 , 1.0 );
				float2 temp_cast_0 = (_TilingA).xx;
				float2 texCoord78 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float2 panner84 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord78);
				float2 temp_cast_1 = (_TilingB).xx;
				float2 texCoord86 = packedInput.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float2 panner83 = ( 1.0 * _Time.y * float2( -0.2,0 ) + texCoord86);
				float3 ase_worldPos = packedInput.ase_texcoord4.xyz;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV20 = dot( packedInput.normalWS, ase_worldViewDir );
				float fresnelNode20 = ( 0.0 + 3.0 * pow( max( 1.0 - fresnelNdotV20 , 0.0001 ), 1.5 ) );
				float4 lerpResult19 = lerp( ( tex2D( _BeamGradientA, panner84 ) * tex2D( _BeamGradientB, panner83 ) ) , float4( 0,0,0,0 ) , fresnelNode20);
				float4 clampResult92 = clamp( lerpResult19 , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
				float2 uv_T_Gradient_Vertical_2wayB = packedInput.ase_texcoord3.xy * _T_Gradient_Vertical_2wayB_ST.xy + _T_Gradient_Vertical_2wayB_ST.zw;
...
WireConnection;98;6;109;0
WireConnection;98;9;93;0
ASEEND*/
//CHKSM=15E6F763640F40A82235BE648AF5614CEC846762