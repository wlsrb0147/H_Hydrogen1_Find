	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				o.ase_texcoord1.xyz = inputMesh.ase_texcoord.xyz;
					...
					)
			{
				...
				float2 texCoord355 = packedInput.ase_texcoord1.xyz.xy * temp_cast_1 + float2( 0,0 );
				...
				float2 texCoord357 = packedInput.ase_texcoord1.xyz.xy * temp_cast_3 + float2( 0,0 );
				...
				float2 texCoord359 = packedInput.ase_texcoord1.xyz.xy * temp_cast_5 + float2( 0,0 );
				...
				float2 texCoord346 = packedInput.ase_texcoord1.xyz.xy * temp_cast_7 + float2( 0,0 );
				...
				float2 texCoord344 = packedInput.ase_texcoord1.xyz.xy * temp_cast_9 + float2( 0,0 );
				...
				float fresnelNdotV381 = dot( ase_worldNormal, V );
				float fresnelNode381 = ( _FresnelBias + 1.0 * pow( max( 1.0 - fresnelNdotV381 , 0.0001 ), _FresnelPower ) );
				...
				float3 worldRefl383 = reflect( -V, float3( dot( tanToWorld0, lerpResult382 ), dot( tanToWorld1, lerpResult382 ), dot( tanToWorld2, lerpResult382 ) ) );
				float3 break384 = worldRefl383;
				float4 appendResult386 = (float4(break384.x , ( break384.y * -1.0 ) , break384.z , 0.0));
				
				surfaceDescription.Color = texCUBE( _Cubemap, appendResult386.xyz ).rgb;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				o.ase_texcoord2.xyz = inputMesh.uv0.xyz;
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float2 temp_cast_0 = (( _MASTERSpeed * _WaterSpeed1 )).xx;
				float2 temp_cast_1 = (( _MASTERTiling * _WaterTile1 )).xx;
				float2 texCoord355 = packedInput.ase_texcoord2.xyz.xy * temp_cast_1 + float2( 0,0 );
				float2 panner364 = ( 1.0 * _Time.y * temp_cast_0 + texCoord355);
				float2 temp_cast_2 = (( _MASTERSpeed * _WaterSpeed2 )).xx;
				float2 temp_cast_3 = (( _MASTERTiling * _WaterTile2 )).xx;
				float2 texCoord357 = packedInput.ase_texcoord2.xyz.xy * temp_cast_3 + float2( 0,0 );
				float2 panner361 = ( 1.0 * _Time.y * temp_cast_2 + texCoord357);
				float2 temp_cast_4 = (( _MASTERSpeed * _WaterSpeed3 )).xx;
				float2 temp_cast_5 = (( _MASTERTiling * _WaterTile3 )).xx;
				float2 texCoord359 = packedInput.ase_texcoord2.xyz.xy * temp_cast_5 + float2( 0,0 );
				float2 panner365 = ( 1.0 * _Time.y * temp_cast_4 + texCoord359);
				float2 temp_cast_6 = (( _MASTERSpeed * _WaterSpeed4 )).xx;
				float2 temp_cast_7 = (( _MASTERTiling * _WaterTile4 )).xx;
				float2 texCoord346 = packedInput.ase_texcoord2.xyz.xy * temp_cast_7 + float2( 0,0 );
				float2 panner352 = ( 1.0 * _Time.y * temp_cast_6 + texCoord346);
				float2 temp_cast_8 = (( _MASTERSpeed * _WaterSpeed5 )).xx;
				float2 temp_cast_9 = (( _MASTERTiling * _WaterTile5 )).xx;
				float2 texCoord344 = packedInput.ase_texcoord2.xyz.xy * temp_cast_9 + float2( 0,0 );
				float2 panner360 = ( 1.0 * _Time.y * temp_cast_8 + texCoord344);
				float3 temp_output_374_0 = BlendNormal( BlendNormal( UnpackNormalScale( tex2D( _WaterNorm, panner364 ), 1.0f ) , UnpackNormalScale( tex2D( _WaterNorm, panner361 ), 1.0f ) ) , BlendNormal( UnpackNormalScale( tex2D( _WaterNorm, panner365 ), 1.0f ) , BlendNormal( UnpackNormalScale( tex2D( _WaterNorm, panner352 ), 1.0f ) , UnpackNormalScale( tex2D( _WaterNorm, panner360 ), 1.0f ) ) ) );
				float3 lerpResult379 = lerp( temp_output_377_0 , temp_output_374_0 , _WaterNormIntensityClose);
				float3 lerpResult380 = lerp( temp_output_377_0 , temp_output_374_0 , _WaterNormIntensityFar);
...
ASEEND*/
//CHKSM=3F6BFBA9E67806BAA1628718A2CE25C1EE8A635E