	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = inputMesh.ase_texcoord.xyz;
						...
						)
			{
				...
				float2 texCoord6 = packedInput.ase_texcoord6.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float4 temp_output_48_0 = ( texCUBE( _Cubemap, refract( ase_tanViewDir , tex2DNode5 , lerpResult21 ) ) * _TintColor );
				
				float3 hdEmission65 = ASEGetEmissionHDRColor(temp_output_48_0.rgb,temp_output_48_0.r,0.0,GetInverseCurrentExposureMultiplier());
				
				float temp_output_22_0 = ( tex2DNode12.g * _TintColor.a );
				
				surfaceDescription.BaseColor = temp_output_48_0.rgb;
				surfaceDescription.Normal = ( tex2DNode5 * isFrontFace );
				...
				surfaceDescription.Emission = hdEmission65;
				surfaceDescription.Smoothness = ( 1.0 - _Roughness );
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = temp_output_22_0;

				#ifdef _ALPHATEST_ON
				surfaceDescription.AlphaClipThreshold = temp_output_22_0;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = inputMesh.uv0.xyz;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord6 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner7 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord6);
				float2 panner8 = ( 1.0 * _Time.y * float2( 0,0.4 ) + texCoord6);
				float lerpResult9 = lerp( tex2D( _Refraction_Waviness, panner7 ).g , tex2D( _Refraction_Waviness, panner8 ).g , 0.5);
				float2 temp_output_13_0 = ( ( texCoord6 + ( _Refraction_Waviness_Intensity * lerpResult9 ) ) + ( _Refraction_UV_Add / 100.0 ) );
		...
		Pass
		{
			...
			AttributesMesh ApplyMeshModification(AttributesMesh inputMesh, float3 timeParameters, inout PackedVaryingsMeshToPS outputPackedVaryingsMeshToPS )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord8.xyz = inputMesh.ase_texcoord.xyz;
						...
						)
			{
				...
				float3 ase_tanViewDir =  tanToWorld0 * V.x + tanToWorld1 * V.y  + tanToWorld2 * V.z;
				ase_tanViewDir = normalize(ase_tanViewDir);
				float2 texCoord6 = packedInput.ase_texcoord8.xyz.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner7 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord6);
				float2 panner8 = ( 1.0 * _Time.y * float2( 0,0.4 ) + texCoord6);
				float lerpResult9 = lerp( tex2D( _Refraction_Waviness, panner7 ).g , tex2D( _Refraction_Waviness, panner8 ).g , 0.5);
				float2 temp_output_13_0 = ( ( texCoord6 + ( _Refraction_Waviness_Intensity * lerpResult9 ) ) + ( _Refraction_UV_Add / 100.0 ) );
		...
		Pass
        {
					...
					)
			{
				...
				float2 texCoord6 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner7 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord6);
				float2 panner8 = ( 1.0 * _Time.y * float2( 0,0.4 ) + texCoord6);
				float lerpResult9 = lerp( tex2D( _Refraction_Waviness, panner7 ).g , tex2D( _Refraction_Waviness, panner8 ).g , 0.5);
				float2 temp_output_13_0 = ( ( texCoord6 + ( _Refraction_Waviness_Intensity * lerpResult9 ) ) + ( _Refraction_UV_Add / 100.0 ) );
...
Node;AmplifyShaderEditor.SamplerNode;10;-1593.737,-184.4941;Inherit;True;Property;_Refraction_Waviness;Refraction_Waviness;5;0;Create;True;0;0;0;False;0;False;-1;443af2a11bb01f845b4c6fcdd3ee2a6b;443af2a11bb01f845b4c6fcdd3ee2a6b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;4;-725.4905,257.4149;Inherit;True;Property;_Normal;Normal;7;0;Create;True;0;0;0;False;0;False;0aa577001ae66b641bef387bb0138b68;0aa577001ae66b641bef387bb0138b68;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;12;-560.689,-170.3526;Inherit;True;Property;_Refraction;Refraction;1;0;Create;True;0;0;0;False;0;False;-1;747d3d4acd2ceb14aa048ae5cea5f566;747d3d4acd2ceb14aa048ae5cea5f566;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;47;180.7822,-643.6104;Inherit;True;Property;_Cubemap;Cubemap;10;0;Create;True;0;0;0;False;0;False;-1;aeec6be8589c79849941a97717ceff50;df17c36dd0a391842bccaa3843230c58;True;0;False;white;Auto;False;Object;-1;Auto;Cube;8;0;SAMPLERCUBE;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;54;4;26;0
WireConnection;54;6;65;0
WireConnection;54;7;28;0
WireConnection;54;9;22;0
WireConnection;54;10;22;0
...
ASEEND*/
//CHKSM=63D0843066087F2D70D2BFC3BFAE0B82AE119CBE