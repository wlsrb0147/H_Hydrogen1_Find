	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord279 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 hdEmission358 = ASEGetEmissionHDRColor(Emission301.rgb,Emission301.r,0.0,GetInverseCurrentExposureMultiplier());
				
				surfaceDescription.BaseColor = FinalDiffuse310.rgb;
				surfaceDescription.Normal = Normal333;
				...
				surfaceDescription.Emission = hdEmission358;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord279 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 UVMaster295 = ( texCoord279 * _MASTER_UVScale );
				float4 tex2DNode2 = tex2D( _Diffuse, UVMaster295 );
				float4 lerpResult345 = lerp( ( _ColorDiffuseMultiply * tex2DNode2 ) , _ColorDiffuseLerp , _Diffuse_Color_Lerp);
				float4 ClearDiffuse307 = lerpResult345;
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord279 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 UVMaster295 = ( texCoord279 * _MASTER_UVScale );
				float3 unpack99 = UnpackNormalScale( tex2D( _NormalDetail, ( UVMaster295 * _NormalDetailScale ) ), _NormalDetailIntensity );
				unpack99.z = lerp( 1, unpack99.z, saturate(_NormalDetailIntensity) );
				float3 unpack338 = UnpackNormalScale( tex2D( _NormalDetail2, ( UVMaster295 * _NormalDetail2Scale ) ), _NormalDetail2Intensity );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord279 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 UVMaster295 = ( texCoord279 * _MASTER_UVScale );
				float4 tex2DNode2 = tex2D( _Diffuse, UVMaster295 );
				float4 lerpResult345 = lerp( ( _ColorDiffuseMultiply * tex2DNode2 ) , _ColorDiffuseLerp , _Diffuse_Color_Lerp);
				float4 ClearDiffuse307 = lerpResult345;
...
WireConnection;347;0;311;0
WireConnection;347;1;334;0
WireConnection;347;6;358;0
WireConnection;347;7;294;0
WireConnection;358;0;302;0
WireConnection;358;1;302;0
ASEEND*/
//CHKSM=7D9E52560E54A77AD74B500453BB31FD36FEEC4A